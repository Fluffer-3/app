...
const RootContextN = React.createContext<RootContext | null>(null);
...
const Root = React.forwardRef<ViewRef, SlottableViewProps & TooltipRootProps>(
    (
        ...
        return (
            <RootContextN.Provider value={{ open, onOpenChange }}>
                <Tooltip.Provider
...
function useTooltipContext() {
    const context = React.useContext(RootContextN);
    if (!context) {
        throw new Error(
